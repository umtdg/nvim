...
-- Default indentation for new files - vim-sleuth handles existing files
vim.o.shiftwidth = 4
vim.o.tabstop = 4
vim.o.softtabstop = 4
...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      --   local disable_filetypes = { c = true, cpp = true, bash = true, rust = true, go = true, python = true, java = true }
